...
frappe.ui.form.AssignToDialog = class AssignToDialog {
	...
	async get_fields() {
		let me = this;
		let myUser = await frappe.db.get_doc("User", frappe.session.user);

		let users = await new Promise((resolve, reject) => {
			frappe.call({
				method: "lawyer.lawyer.law_api.getAssignTo",
